...
<head>
    ...
    <title>Jersian.co</title>
    <meta name="description" content="">
    <meta name="keywords" content="">

    <!-- jersians -->
    <link href="assets/img/jersian.png" rel="icon">
...
<body class="index-page">
    ...
    <header id="header" class="header d-flex align-items-center sticky-top">
        <div class="container-fluid container-xl position-relative d-flex align-items-center justify-content-between">
            ...
            <a href="index.html" class="logo d-flex align-items-center">
                ...
                <h1 class="sitename">Jersian.co</h1>
            </a>
            ...
            <nav id="navmenu" class="navmenu">
                <ul>
                    ...
                    <li><a href="#team">Review</a></li>
                    <li class="dropdown"><a href="#"><span>Search By</span> <i
                    ...
                    <li><a href="#profile" style="padding-left: 50px;"><img src="assets/img/profile.png"
                                alt="Profile Logo" style="width: 25px; height: 26px;"></a></li>
                </ul>
    ...
    <main class="main">
        ...
        <section id="hero" class="hero section dark-background">
            ...
            <div class="container text-center" data-aos="fade-up" data-aos-delay="100">
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <h2>Welcome to Jersian</h2>
                        <p>Jersian biar keren</p>
        ...
        <section id="about" class="about section">
            ...
            <div class="container section-title" data-aos="fade-up">
                <h2>Driven by Passion</h2></h2>
                <p>Menjadikan setiap jersey sebagai simbol dari dedikasi </p>
            ...
            <div class="container" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-6 order-2 order-lg-1 content">
                        ...
                        <p style="text-align: justify; line-height: 2.0; margin: 2 auto; max-width: 760px;">
                            Jersey vintage yang kami jual hadir dengan kualitas premium dan desain ikonik
                            yang membawa Anda kembali untuk bernostalgia. Dibuat dengan bahan berkualitas
                            yang nyaman, setiap jersey merupakan produk asli, dengan detail yang autentik
                            dari setiap klub-klub legendaris. Kami juga menyediakan beberapa ukuran dengan
                        ...
                        <div class="service-item d-flex">
                            ...
                            <div>
                                <h4 class="title"><a href="service-details.html" class="stretched-link">Eiusmod
                                        Tempor</a></h4>
                                <p class="description">Et harum quidem rerum facilis est et expedita distinctio dasa
                                    fermo lind saca</p>
                            </div>
                        </div>
                    </div><!-- End Service Item -->
            ...
            <div class="container">
                ...
                <div class="isotope-layout" data-default-filter="*" data-layout="masonry"
                    ...
                    <ul class="portfolio-filters isotope-filters" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <li data-filter=".filter-app">Club</li>
                        <li data-filter=".filter-product">National Team</li>
                        <li data-filter=".filter-branding">Men</li>
                        <li data-filter=".filter-books">Women</li>
    ...
    <footer id="footer" class="footer dark-background">
        ...
        <div class="container copyright text-center mt-4">
            <p>© <span>Copyright</span> <strong class="px-1 sitename">Amoeba</strong> <span>All Rights Reserved</span>
            </p>
            <div class="credits">
...
<?php /**PATH D:\KULIAH\SEMESTER 6\MPTI\ThriftWave\resources\views/welcome.blade.php ENDPATH**/ ?>